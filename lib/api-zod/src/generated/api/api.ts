 ...
 */
export const runBacktestBodyTimeframeDefault = `15m`;
export const runBacktestBodyCandleCountDefault = 500;
export const runBacktestBodyCandleCountMin = 100;
export const runBacktestBodyCandleCountMax = 1000;

export const runBacktestBodyTradeAmountUsdDefault = 100;
export const runBacktestBodyStopLossPercentDefault = 2;
export const runBacktestBodyTakeProfitPercentDefault = 5;
export const runBacktestBodyFeePercentDefault = 0.1;
export const runBacktestBodyWarmupBarsDefault = 60;
export const runBacktestBodyWindowBarsDefault = 100;
...
export const RunBacktestBody = zod.object({
  ...
  candleCount: zod
    .number()
    .min(runBacktestBodyCandleCountMin)
    .max(runBacktestBodyCandleCountMax)
    .default(runBacktestBodyCandleCountDefault),
  tradeAmountUsd: zod.number().default(runBacktestBodyTradeAmountUsdDefault),
  ...
  feePercent: zod.number().default(runBacktestBodyFeePercentDefault),
  warmupBars: zod.number().default(runBacktestBodyWarmupBarsDefault),
  windowBars: zod.number().default(runBacktestBodyWindowBarsDefault),
});
